...
func (l *Logger) CheckOrInterval(skip int) bool { return l.wrapper.checkRateOrInterval(skip + 1) }

func (l *Wrapper) CheckOrInterval(skip int) bool { return l.checkRateOrInterval(skip + 1) }
