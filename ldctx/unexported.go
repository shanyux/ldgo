...
func LogE(c context.Context, msg string, fields ...zap.Field) { zCore(c, 1).Error(msg, fields...) }
func LogF(c context.Context, msg string, fields ...zap.Field) { zCore(c, 1).Fatal(msg, fields...) }
...
func LogEf(c context.Context, fmt string, args ...interface{}) { zSugar(c, 1).Errorf(fmt, args...) }
func LogFf(c context.Context, fmt string, args ...interface{}) { zSugar(c, 1).Fatalf(fmt, args...) }
